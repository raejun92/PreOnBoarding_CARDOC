...
export const signup = async (req, res, next) => {
	...
	if (isUser)
		return res.status(statusCode.BAD_REQUEST).json({ meesage: statusMessage.BAD_REQUEST });
	...
	return res.status(statusCode.OK).json({ token, message: statusMessage.OK });
};
...
export const login = async (req, res, next) => {
	...
	res.status(statusCode.OK).json({ token, message: statusMessage.OK });
};